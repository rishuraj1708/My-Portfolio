          ...
          <div className="flex-1">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                <label htmlFor="hemlanscss" className="w-2/12">HTML & CSS</label>
              ...
              <div className="flex items-center">
                <label htmlFor="hemlanscss" className="w-2/12">React JS</label>
                <div className="grow bg-gray-800 rounded-full h-2.5 ">
              ...
              <div className="flex items-center">
                <label htmlFor="hemlanscss" className="w-2/12">Node JS</label>
                <div className="grow bg-gray-800 rounded-full h-2.5 ">
